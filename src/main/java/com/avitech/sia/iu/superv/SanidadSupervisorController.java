...
public class SanidadSupervisorController {
    ...
    private void goSupplies() {
        App.goTo("/fxml/superv/suministros_super.fxml", "SIA Avitech — Suministros");
    }
    ...
    private void goProduction() {
        App.goTo("/fxml/superv/produccion_super.fxml", "SIA Avitech — Producción");
    }

    @FXML
    private void goReports() {
        App.goTo("/fxml/superv/reportes_super.fxml", "SIA Avitech — Reportes");
    }

    @FXML
    private void goAlerts() {
        App.goTo("/fxml/superv/alertas_super.fxml", "SIA Avitech — Alertas");
    }

    @FXML
    private void goAudit() {
        App.goTo("/fxml/superv/auditoria_super.fxml", "SIA Avitech — Auditoría");
    }

    @FXML
    private void goParams() {
        App.goTo("/fxml/superv/parametros_super.fxml", "SIA Avitech — Parámetros");
    }

    @FXML
    private void goUsers() {
        App.goTo("/fxml/superv/usuarios_super.fxml", "SIA Avitech — Usuarios");
    }

    @FXML
    private void goBackup() {
        App.goTo("/fxml/superv/respaldos_super.fxml", "SIA Avitech — Respaldos");
    }
