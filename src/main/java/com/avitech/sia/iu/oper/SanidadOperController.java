...
public class SanidadOperController {

    private static final Logger LOG = Logger.getLogger(SanidadOperController.class.getName());
    ...
    // KPIs
    @FXML private Label kpiAplicaciones;
    @FXML private Label kpiAplicacionesDelta;
    @FXML private Label kpiMortalidad;
    @FXML private Label kpiCasosActivos;
    @FXML private Label kpiMedStock;
    @FXML private Label kpiMedBajos;
    ...
    private void initialize() {
        // Header
        lblHeader.setText("Operador");
        lblUserInfo.setText("Operador");
        ...
        // Example placeholder plans
        planesData.setAll(
                new PlanRow("Programa Vacunación Ponedoras", "Aplicar según edad y cronograma", "7–72 semanas", "Preventivo"),
                new PlanRow("Tratamiento Respiratorio", "Síntomas respiratorios y recuperación", "Todos", "Curativo")
        );
    ...
    private void loadMedicamentos() {
        try {
            ...
            tblMedicamentos.setItems(FXCollections.observableArrayList());
        }
    }
    ...
    private void loadFilterCombos() {
        try {
            ...
            // fallback defaults
            cbGalpon.setItems(FXCollections.observableArrayList("Todos","1","2","3"));
            cbMedicamento.setItems(FXCollections.observableArrayList("Todos"));
            cbGalpon.getSelectionModel().selectFirst();
            cbMedicamento.getSelectionModel().selectFirst();
        }
    }
    ...
    @FXML private void goHealth()     { /* ya estás aquí */ }
    ...
    private void onBuscar() {
        // TODO: implementar filtros exactos
    ...
    public static class MedRow {
        ...
        public StringProperty stockTextoProperty() { return new SimpleStringProperty(stock.get() + " unidades"); }
